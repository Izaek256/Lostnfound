 ...
 * 
 * This page allows users to report lost items and sends data to Server A
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Create a temporary file to handle the form data
    $tempFile = tempnam(sys_get_temp_dir(), 'lost_item_');
    ...
    if (empty($formData['title']) || empty($formData['description']) || empty($formData['location']) || empty($formData['contact'])) {
        ...
        if (isset($response['success']) && $response['success']) {
            ...
            $message = $response['error'] ?? 'Failed to report lost item. Please try again.';
            $messageType = 'error';
        }
    }
}

// Get recent lost items for display
$recentItemsData = makeAPICall('get_items', ['filter' => 'lost', 'limit' => 3], 'GET');
$recentLostItems = [];

if (isset($recentItemsData['success']) && $recentItemsData['success']) {
    $recentLostItems = $recentItemsData['items'];
}
?>
...
<body>
    ...
    <main>
        ...
        <section class="form-container">
            ...
            <p>Help others find your lost item by providing detailed information.</p>
        ...
        <section class="form-container">
            ...
            <p>Check if your item has already been reported by someone else.</p>
                ...
                <?php foreach ($recentLostItems as $item): ?>
                    <div class="item-card">
                        ...
                        <div class="item-card-body">
                            ...
                            <p><strong>Contact:</strong> <a href="mailto:<?php echo htmlspecialchars($item['contact']); ?>"><?php echo htmlspecialchars($item['contact']); ?></a></p>
